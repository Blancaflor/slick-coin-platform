  ...
  <Layout>
    ...
    <div className="Hero2">
      <div className="HeroGroup2">
        ...
        <p href="#">SLICK coin can be discovered in the PancakeSwap or can be searched in Metamask</p>
        <a class="Account" href="https://bscscan.com/address/0x72c7989aa5643bf7edbde703517d6f007d0436dc" target="_blank"><p>Slick Address BscScan</p></a>
        <a class="Account" href="https://trustwallet.com/" target="_blank"><p>Get Trust Wallet & Buy on PancakeSwap</p></a>
      ...
      <div className="Hero2">
        <div className="HeroGroup2">
          ...
          <a class="Account" href="https://lobstr.co/" target="_blank"><p>Not in ownership of a Lobstr account yet?</p></a>
          <a class="Account" href="https://stellar.expert/explorer/public/account/GDL2QBT4SEWIF2HOXBLKTQPG7ZVUVCCEI7USTV75ISW2NY254M7W2RQX" target="_blank"><p>SLICK Address Stellar Expert</p></a>
        </div>
        <div className="spacebetween">
          <Wave />
        </div>
